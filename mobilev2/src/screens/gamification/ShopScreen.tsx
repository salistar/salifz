...
import { IconeGemmes, IconeCoeurs, IconeSerie, IconeBoutique, IconeRecompense, IconeProfil } from '../../components/common/Icones';
...
const DAILY_REWARDS = [
  ...
  { day: 5, gems: 25 },
  { day: 6, gems: 35 },
  { day: 7, gems: 50, bonusGel: true }
];

const SHOP_ITEMS = [
  { id: 'heart_refill', nameKey: 'shop.items.heartRefill.name', nameEnKey: 'shop.items.heartRefill.nameEn', Icone: IconeCoeurs, price: 350, descriptionKey: 'shop.items.heartRefill.description' },
  { id: 'streak_freeze', nameKey: 'shop.items.streakFreeze.name', nameEnKey: 'shop.items.streakFreeze.nameEn', Icone: IconeSerie, price: 200, descriptionKey: 'shop.items.streakFreeze.description' },
  { id: 'xp_boost', nameKey: 'shop.items.xpBoost.name', nameEnKey: 'shop.items.xpBoost.nameEn', Icone: IconeRecompense, price: 500, descriptionKey: 'shop.items.xpBoost.description' },
  { id: 'avatar_gold', nameKey: 'shop.items.avatarGold.name', nameEnKey: 'shop.items.avatarGold.nameEn', Icone: IconeProfil, price: 1000, descriptionKey: 'shop.items.avatarGold.description' },
  { id: 'gems_100', nameKey: 'shop.items.gems100.name', nameEnKey: 'shop.items.gems100.nameEn', Icone: IconeGemmes, price: 0, realPrice: '$0.99' },
  { id: 'gems_500', nameKey: 'shop.items.gems500.name', nameEnKey: 'shop.items.gems500.nameEn', Icone: IconeGemmes, price: 0, realPrice: '$3.99' }
];
    ...
    <View style={styles.container}>
      ...
      <LinearGradient colors={[colors.accentDeep, colors.accentDeep]} style={styles.header}>
        ...
        <View style={styles.gemsDisplay}>
          <IconeGemmes size={18} color={colors.info} />
            ...
            {DAILY_REWARDS.map((reward, index) => {
              ...
              return (
                ...
                >
                  ...
                  {isPast && <Ionicons name="checkmark" size={12} color={colors.primary} />}
                </View>
              );
            })}
          </View>
            ...
            >
              <View style={styles.itemIconContainer}>
                <View style={styles.itemIcon}>
                  <item.Icone size={28} color={colors.primary} />
                </View>
              </View>
