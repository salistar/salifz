 ...
 * ✅ FIXED: Added HalaqaChat screen
 * ✅ FIXED: Delay API calls until token is ready
 * ✅ FIXED: Social Tab with Chat, Halaqa, Friends
 */
...
function MainTabs() {
  ...
  // ✅ Charger le nombre de messages non lus avec délai
  useFocusEffect(
    useCallback(() => {
      let isMounted = true;
      ...
      const loadUnreadCount = async () => {
        ...
        try {
          ...
          console.log('[MainTabs] Unread count:', count);
