...
export default function ChatScreen({ route, navigation }: any) {
  ...
  const setupSocketListeners = () => {
    ...
    socketService.on('userOnline', () => setIsOnline(true));
    socketService.on('userOffline', () => setIsOnline(false));
  };
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <LinearGradient colors={[COLORS.primary, '#2E7D32']} style={styles.header}>
        ...
        <TouchableOpacity style={styles.userInfo} onPress={() => navigation.navigate('UserProfile', { userId: recipientId })}>
          ...
          <View style={styles.userDetails}>
            ...
            <Text style={styles.userStatus}>
              {recipientTyping ? 'يكتب...' : isOnline ? 'متصل الآن' : 'غير متصل'}
            </Text>
          </View>
        </TouchableOpacity>
        
        <View style={styles.headerActions}>
          <TouchableOpacity style={styles.headerButton} onPress={() => navigation.navigate('ChatAudio', { recipientId, recipientName })}>
            <Text style={styles.headerButtonIcon}>📞</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.headerButton} onPress={() => navigation.navigate('ChatVideo', { recipientId, recipientName })}>
            <Text style={styles.headerButtonIcon}>📹</Text>
          </TouchableOpacity>
        </View>
      </LinearGradient>
      ...
      {recipientTyping && (
        <View style={styles.typingIndicator}>
          <Text style={styles.typingText}>{recipientName} يكتب...</Text>
        </View>
      )}
